...
import umc.UMC8thSpring.validation.validator.CheckMissionNotInProgressValidator;

import java.lang.annotation.*;

@Documented // 사용자 정의 어노테이션
@Constraint(validatedBy = CheckMissionNotInProgressValidator.class) // validation을 커스텀 어노테이션을 통해 할 수 있도록
...
public @interface CheckMissionNotInProgress {
