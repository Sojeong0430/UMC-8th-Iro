...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 1642176933L;
    ...
    public final umc.UMC8thSpring.domain.QMission mission;

    public final EnumPath<umc.UMC8thSpring.domain.enums.MissionStatus> status = createEnum("status", umc.UMC8thSpring.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new umc.UMC8thSpring.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
